...
const ProfEducation = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const existingCookieData = Cookies.get("pro-details");
        ...
        document.cookie = `pro-details=${encodeURIComponent(JSON.stringify(mergedFormData))}; path=/`;

        router.push('/pro/Third');
    };
                ...
                rounded-md"
                    ...
                    <div>
                        <label className="block mb-6">
                            <span className="text-sm text-[#777777]">Course Type</span>
                            <select
                                name="courseType"
                                required
